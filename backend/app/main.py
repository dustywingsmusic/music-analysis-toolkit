    ...
    if segment_duration_sec > LOCAL_ANALYSIS_STREAMING_THRESHOLD_S:
        ...
        with sf.SoundFile(filepath, 'r') as f:
            ...
            while samples_processed < num_samples_to_read:
                samples_this_chunk = min(chunk_size, num_samples_to_read - samples_processed)
...
def _perform_analysis(
    ...
    return ModeAnalysisResponse(
        ...
        local=LocalAnalysis(
            ...
            tonic=local_key_info["tonic"], key_signature=local_key_info["key_signature"], mode=local_key_info["mode"],
...
@app.post("/analyze-mode/", response_model=ModeAnalysisResponse,
