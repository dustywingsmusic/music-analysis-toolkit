...
export const MODE_TO_SCALE_FAMILY: { [key: string]: string } = {
  ...
  'Ultra-Locrian': 'Double Harmonic Major',
  'Lydian ♯2 ♯6': 'Double Harmonic Major',
  'Lydian #2 #6': 'Double Harmonic Major',
  'Ultraphrygian': 'Double Harmonic Major',
  'Oriental': 'Double Harmonic Major',
  'Ionian Aug ♯2': 'Double Harmonic Major',
  'Ionian Aug #2': 'Double Harmonic Major',
  'Blues': 'Blues Scale',
  'Blues Scale': 'Blues Scale',
  'Blues Mode II': 'Blues Scale',
  'Blues Mode III': 'Blues Scale',
  'Blues Mode IV': 'Blues Scale',
  'Blues Mode V': 'Blues Scale',
  'Blues Mode VI': 'Blues Scale',
